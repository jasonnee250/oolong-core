...
import LeftIcon from '@/resource/icons/text/text-left.svg?react'
import CenterIcon from '@/resource/icons/text/text-center.svg?react'
import RightIcon from '@/resource/icons/text/text-right.svg?react'
...
export const TextHorizonPanel = ({oolongApp,currentAlignType}:Iprops) => {
    ...
    return (
        <div className="text-horizon-panel">
            ...
            <ButtonContainer noneExpand={true} onClick={()=>clickAlign(TextAlignType.CENTER)}
                             isSelected={currentAlignType===TextAlignType.CENTER}>
                <CenterIcon/>
            </ButtonContainer>
            <ButtonContainer noneExpand={true} onClick={()=>clickAlign(TextAlignType.BOTTOM_OR_RIGHT)}
